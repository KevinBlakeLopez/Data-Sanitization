...
const REgroup1 = [USre, USre2, USre3, USre4, USre5, USre6, USre7, USre8, USre9, USre10, USre11, USre12, USre13, USre14, USre15, USre16, USre17, USre18, USre19, numUS1];
const REgroup2 = [numUSType2, USnum, ITre, ITre2, Wnum, WnumITnum, USnum1, USnum3, ITUSre6, ITUSre7, ITUSre9, ITUSre10, ITUSDEre6, ITUSDEre7, ITUSre8];
...
const products = [
  { gender: "menswear", category: "pants", size: "W25 | L34" },
  { gender: "womenswear", category: "shorts", size:"10 | XL" }
];
...
function findMatches() {
  const matches = [];
  let regexes;
  products.forEach(matchIt);
  function matchIt(product) {
  ...
  else if (product.gender === "womenswear") {
    switch (product.category) {
        case "accessories":
